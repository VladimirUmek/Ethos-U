...
// TensorFlow Lite Micro builds its interpreter, allocator and op resolver on
// the stack, and the CMSIS-NN kernels take further working space on top. The
// 4 kB that the board template ships is not enough for the CPU inference path.
