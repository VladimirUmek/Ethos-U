...
// fill array
 arr.push( new tabElement( "General",      "/general/html/",      "General"      ));
 arr.push( new tabElement( "Drivers",      "/drivers/html/",      "Drivers"      ));
 arr.push( new tabElement( "Integration",  "/integration/html/",  "Integration" ));
